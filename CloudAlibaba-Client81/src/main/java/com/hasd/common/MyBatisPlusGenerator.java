...
public class MyBatisPlusGenerator {
    ...
    //Mapper 路径
    public static final String OUT_PUT_FILE = "D:/Code/E-WoodFish-Server-Cloud/CloudAlibaba-Client81/src/main/resources/mapper";
    // 父级路径
    public static final String PARENT_PATH = "D:/Code/E-WoodFish-Server-Cloud/CloudAlibaba-Client81/src/main/java";
    // 父级包名
